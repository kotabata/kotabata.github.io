...
- [Academic Website Template User Guide](#academic-website-template-user-guide)
  ...
  - [8. Customize SEO and Google Search Console in index.html](#8-customize-seo-and-google-search-console-in-indexhtml)
...
## 8. Customize SEO and Google Search Console in index.html
...
2. Replace the following information with your GitHub username or full name:
   ...
   - Edit the `content` attribute of `<meta name="description">` to match your research content
   - Change the `content` attribute of `<meta name="author">` to your name
   - Change the `href` attribute of `<link rel="canonical">` to your GitHub Pages URL
   - Change the `"url"` and `"target"` in `<script type="application/ld+json">` to your GitHub Pages URL
3. Save the changes and commit them

> **Tip**: Proper SEO settings can improve your visibility in search engines.
